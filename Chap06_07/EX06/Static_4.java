...
class Cde {
	String name ;				// 필드 (인스턴스 필드) : 객체화 해야 사용 가능
	int age;
	
	static String email;		// 필드 (static(정적) 필드 : 객체 생성 없이 사용 가능 (클래스명.필드명) + 객체 생성 후 사용
	static int num;
...
public class Static_4 {
	...
	public static void main(String[] args) {
		...
		cde1.email = "zzz@zzz.z";
		cde1.num = 4;
		
		// 객체 생성 없이 static 필드 호출 : 클래스 명으로 호출 가능 : < 권장 사항 >
				// 모든 객체들이 공유하는 공간
