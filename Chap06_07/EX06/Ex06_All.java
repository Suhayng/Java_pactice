...
class Abc { 	// 외부 클래스 : public 제어자를 사용 못한다. default 기본으로 적용
				...
				// 접근 제어자 : 
					...
					// 2. protected : 다른 패키지에서 접근 가능 ( 상속 구현이 되어 있어야 가능 )
	...
	protected void print2() {
		System.out.println("다른 패키지에서 접근 가능(상속 관계가 구성될 때) : protected");
	}
	void print3() {
...
public class Ex06_All {
	...
	public static void main(String[] args) {
		...
		// Abc : 클래스명, abc1 : 메모리에 로드할 객체명, new = 객체를 Heap 영역에 생성, Abc() : 생성자 호출 
			// Abc() : 기본 생성자, 생략가능, Abc() {}  
				// 생성자 : 1. 클래스 이름과 동일한 메소드/ 2. 리턴 타입이 없는 메소드 생성자

		// 같은 패키지 내에서 필드 호출
		abc1.a = 100;		// public
		abc1.b = 200;		// protected
		abc1.c = 300;		// default
	//	aba1.d = 400;		// private, 다른 클래스에서는 접근 불가
