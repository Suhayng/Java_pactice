...
public class RectangleValueAssignment_Ex07 {
	public static void main(String[] args) {
		// 1. 배열 객체의 생성 및 원소값 대입 (방법 1), 배열의 초깃값을 알 수 없는 경우
		 	// Rectacngle ( 정방형 배열 ) : 직사각형으로 출력, 각각의 행의 열의 개수가 같다.
		...
		// 2. 배열 객체의 생성 및 원소값 대입 (방법 2) : 초깃값을 알 때 사용
