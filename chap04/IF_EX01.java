...
public class IF_EX01 {
	public static void main(String[] args) {
		...
		if (bool1) {
			System.out.println("실행3"); 			// 조건이 True 일 때 실행
		}else {
			System.out.println("실행4");			// 조건이 False 일 때 실행
		}
		
		if (bool2) {
			System.out.println("실행5"); 			// 조건이 True 일 때 실행
		}else {
			System.out.println("실행6");			// 조건이 False 일 때 실행
		}
		System.out.println("===================");
		...
		if (value3 >= 90) {
			...
			System.out.println("C학점 , 점수 :" + value3);			// 실행 후에 if 문을 빠져 나온다.
		}else if (value3 >= 80) {
		...
		if (value3 >= 90) {
			...
			System.out.println("B학점 , 점수 :" + value3);			// 실행 후에 if 문을 빠져 나온다.
		}else if (value3 >= 80) {
