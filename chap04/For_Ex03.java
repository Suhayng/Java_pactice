...
public class For_Ex03 {
	public static void main(String[] args) {
		...
		//  for 문을 사용해서 1부터 10까지 * 값을 출력해 보세요
		int s=1;
		for (int i = 1 ; i <= 10; i++) {
			s *= i ;	// s = s * i
		}
		...
		// for 문을 사용해서 1더한 값 100까지 더한 값을 출력
		...
		*/
		...
		System.out.println(" 1부터 1000까지 4의 배수만 더한 값 : " + sum);
		
		
		System.out.println(" 1부터 1000까지 4의 배수만 더한 값의 평균값 : " + sum/250);
		 */
